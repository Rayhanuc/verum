         ...
         <div class="col-md-8">
             ...
             <div class="about-info text-left">
                 ...
                 <div class="text-center">
                     <img class="img-fluid" src="<?php echo esc_url($verum_about_footer_image[0]); ?>" alt="<?php the_title(); ?>"/>
                 </div>
                 <div class="about-social-links text-center">
                    ...
                    <a href="<?php echo esc_url($verum_social_links['twitter']);?>"><i class="fa fa-twitter"></i></a>
                 	<?php endif; ?>
                 	<?php if($verum_social_links['linkedin']): ?>
                    <a href="<?php echo esc_url($verum_social_links['linkedin']);?>"><i class="fa fa-linkedin"></i></a>
                 	<?php endif; ?>
             </div>
         </div>
     </div>
