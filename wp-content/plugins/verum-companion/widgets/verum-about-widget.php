...
class Verumabout_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<p class="mt-3"><em>'.esc_html($instance['verum_about_description']).'</em></p>';

		if ($instance['verum_about_signature']) {
			echo wp_get_attachment_image( $instance['verum_about_signature'],'medium' );
		}
